  ...
  <div class="in-wrap">
    ...
    <header id="header">
      <section class="container">
        <h1 id="logo">
          <a href="#" title="Laptoy之谷粒学院">
            <img src="~/assets/img/logo.png" width="100%" alt="Laptoy之谷粒学院" />
          </a>
        </h1>
        <div class="h-r-nsl">
          <ul class="nav">
      ...
      <section class="container">
        <div class>
          ...
          <ul class="of flink-list">
            <li>
              <a href="http://www.atguigu.com/" title="Laptoy" target="_blank">Laptoy</a>
            </li>
          </ul>
          <div class="clear"></div>
        </div>
